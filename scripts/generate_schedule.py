...
def _run(
    ...
    *,
    ...
    if scheduler == "orbit_pack_shuffled":
        # Negative control: k/c define the step profile to reproduce, not
        # a cap this schedule respects. order is ignored.
...
def main(argv=None) -> int:
    ...
    p.add_argument(
        ...
        type=int,
        default=0,
        help="RNG seed for orbit_pack_shuffled's orbit->step assignment. "
    ...
    if args.scheduler in ("orbit_pack", "orbit_pack_shuffled"):
